...
//fun��o que ir� se comunicar com o Domain Controller, receber o dom�nio e ajustar para apresentar na tela
...
//fun��o para checkar se dom�nio foi preenchido corretamente
function checkForm() {
